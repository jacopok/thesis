...
The formation mechanism of the Moon is not a settled debate: the giant impact scenario, in which a large planetary object dubbed Theia impacted a young Earth thus forming a disk of debris which coalesced into our satellite, is the dominant theory, but it does not stand unchallenged. 
...
![Horizon for equal mass black hole binaries as seen by the detectors for the next decade: Einstein Telescope, Lunar Gravitational Wave Antenna and LISA](figures/horizon_IMBH.pdf){#fig-horizon-multiband width=80%}

![Time to merger as a function of mass, highlighting at which point various sources would cross the decihertz band.](figures/time_to_merger.pdf){#fig-time-to-merger-lgwa width=80%}
...
![](figures/ra_dec_corner_gw170817.png){#fig-lgwa-gw170817-sky width=80%}
...
![](trajectories.pdf){#fig-trajectories-lgwa-injections width=80%}

![](lgwa_waveforms_month_by_month.pdf){#fig-waveforms-lgwa-injections width=80%}

![](sky_locs.pdf){#fig-injections-sky-areas width=80%}

![](sky_loc_vs_theory.pdf){#fig-injections-vs-wen-chen width=80%}
