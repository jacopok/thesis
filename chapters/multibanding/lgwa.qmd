...
### Spanned area scaling validation
...
![Sky localization areas for the 12 month normalized injections.](figures/sky_locs.pdf){#fig-injections-sky-areas width=80%}

![](figures/sky_loc_vs_theory.pdf){#fig-injections-vs-wen-chen width=80%}
