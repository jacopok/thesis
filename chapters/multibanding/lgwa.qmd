...
For more details on the specific priors we employ and other details, see @tissinoGeometryLunarGravitational2026.
...
|---:|----:|---:|
| global optimum  | $f_{22}=0.54$ Hz | 0.09 s |
| Earth | $f_{22}=0.54$ Hz | 0.16 s |
| Moon | merger | 0.23 s |
| Earth | merger | 0.24 s |
| Solar System Barycenter | merger | 10.56 s |
| Solar System Barycenter | $f_{22}=0.54$ Hz | 10.64 s |
| Earth | $f_{22}=0.03$ Hz | 217 s |
""")
```
...
![Velocity of the minimum uncertainty position compared with the detector's position and velocity.](figures/minimum_uncertainty_velocity.pdf){#fig-minimum-uncertainty-velocity width=80%}
...
![Waveforms for the 11 and 12 month normalized injections, shown in characteristic strain, together with the LGWA PSD and the .](figures/lgwa_waveforms_month_by_month.pdf){#fig-waveforms-lgwa-injections width=80%}
