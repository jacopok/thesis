...
This chapter introduces the detector concept for the Lunar Gravitational Wave Antenna,
following the whitepaper we recently published as a collaboration [@ajithLunarGravitationalwaveAntenna2025], 
and outlines some novel contributions, namely the first discussions on the issues related to full 
...
while using the modified $f^{4/3}$ PSD we get an order of magnitude lower result, 33 mHz.
