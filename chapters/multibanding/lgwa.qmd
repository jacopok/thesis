...
to be representative of the distributions $p(\theta | d = h_0 + n)$. 
In order to validate this, we perform a campaign of 250 injections, 
in the same scenario except for a different noise realization, and compare them to the zero-noise case.
