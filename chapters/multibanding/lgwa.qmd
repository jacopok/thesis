...
one would observe at any given time on the Moon: it is a root-mean-square taken over a year,
which means it considers the contribution of loud events which are well-localized in time.
For the purposes of the LGWA, these may simply lead to a fraction of the data, as opposed to making
