...
The scalar lunar response $L(f)$ has units of length, and it is defined as
$$
...
Compact binaries are a natural candidate.
...
$$
where the scalar products are computed according to the estimated LGWA strain noise PSD, which is computed based on the displacement noise PSD for the optimistic Silicon model in @fig-lgwa-displacement-noise and the estimated response
$$
...
![](figures/ra_dec_corner_gw170817.png){#fig-lgwa-gw170817-sky width=60%}
