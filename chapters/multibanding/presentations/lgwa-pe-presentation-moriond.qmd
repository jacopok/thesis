...
post_full = pd.read_csv(run_folder / 'chains' / 'equal_weighted_post.txt', sep=' ').iloc[:1000]
...
```{python}
ra_lims = np.deg2rad([197+24/60, 197+30/60])
dec_lims = np.deg2rad([-24+35/60, -24+41/60])
# fig=plt.figure(figsize=(5.2, 5.5))
