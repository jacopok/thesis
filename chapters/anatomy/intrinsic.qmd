...
This chapter continues in the dissection of the gravitational signal 
emitted by the coalescence of two compact objects by considering 
its intrinsic parameters, those relating to the source itself and not to its relation to the observer.
...
This chapter also contains a discussion of the results presented in @tissinoCombiningEffectiveonebodyAccuracy2023,
...
Relaxing the $\omega_n \ll \bar{\omega}_{\text{orb}}$ assumption means considering 
