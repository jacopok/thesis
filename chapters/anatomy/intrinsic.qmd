...
The main tidal contribution to the waveform is through the effective tidal parameter, which enters the expansion at 5PN order [@wadeSystematicStatisticalErrors2014]:
$$
...
The analysis so far has focused on the static case; this is equivalent to assuming that the excitation of the normal modes of a neutron star follows the forcing term (_i.e._ the other star's tidal field). 
Relaxing this assumption leads us to consider the effect of _dynamical_ (also known as _resonant_) tides.
These can impact the phasing at low frequencies in the case of eccentric binaries
[@gambaResonantTidesBinary2023].
This, as well as the impact of higher multipoles of the stars' deformation, is in any case generally considered to be a correction to the dominant behaviour, _i.e._ the quasi-static excitation of the quadrupolar normal mode of the star.
...
@buonannoComparisonPostNewtonianTemplates2009 give a comparison of some commonly used Post-Newtonian waveform approximant, including the frequency-domain one `TaylorF2`, whose frequency-domain waveforms read [@messinaQuasi55PNTaylorF2Approximant2019]:
$$
