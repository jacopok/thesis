...
For an example of how the waveform ratio $r(f)$ looks, see @fig-projected-lgwa-waveforms-ratio, where it is computed in a specific case for the Lunar Gravitational Wave Antenna.
