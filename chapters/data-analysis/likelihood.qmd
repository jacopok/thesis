...
in the context of an injection for which the true waveform parameters are known
and we can therefore set $h_0 = h_{\text{true}}$.
...
the same extends to the distributions of $\delta A_0(b)$ and $\delta A_1(b)$
