...
Whereas relative binning seeks to closely approximate the likelihood in the region where waveforms "look similar to each other", reduced order quadrature allows us to obtain a representation which is valid for any point in the prior space [@tiglioReducedOrderSurrogate2022;@morisakiRapidLocalizationInference2023].
