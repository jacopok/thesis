from .lgwa_nested_sampling import run_pocomc, make_analysis_functions, from_bilby
...
if __name__ == '__main__':
    ...
    folder_name = f'pocomc_{n_months}_months'
    ...
    run_pocomc(loglike, prior_transform, inverse_prior_transform, log_dir, param_names, injection_params, n_chain=500_000, n_walkers=40)
