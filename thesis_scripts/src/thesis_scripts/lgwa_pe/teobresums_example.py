...
q = injection_params['mass_ratio']
eta = q / (1+q)**2
total_mass = injection_params['chirp_mass'] / eta**(3/5)
...
pars = {
    ...
    'M'                  : total_mass,
    'q'                  : q,  
    'chi1'               : injection_params['chi_1'],
    'chi2'               : injection_params['chi_2'],
    'distance'           : injection_params["luminosity_distance"],
    'inclination'        : injection_params["theta_jn"],
    ...
    'interp_uniform_grid': "no",  # Interpolate the output waveform a uniform grid, mode by mode
...
pars['df']     = 1.0/seglen
freqs = np.geomspace(35, 500, num=100)
# pars["interp_freqs"] = "yes"
# pars["freqs"] = list(freqs)
pars['initial_frequency'] = freqs[0]
pars['srate_interp'] = freqs[-1] * 2
