...
I want to do it justice, which will require adding some extra analyses and figures;
for example, performing some noisy injections with the LGWA. 
They had been on my to-do list for a while and I'm happy your review gives me
motivation to add them.
The noisy injections are already nearly complete---however, 
writing them up and fixing all the other points will take some days.

Meanwhile, I would like to provide a brief reply to your questions on the Introduction.
You should also receive an updated CV, which includes a mention of the main 
talks I gave (another referee raised the point that they were missing).

The repository containing the source code is not public yet; 
the plan I discussed with my supervisor is to release it upon graduation.
I am, however, happy to share it before, especially if there are any specific points 
...
Regarding my contributions to the various papers I coauthored, I can give a draft of my 
answers here, and I will work on melding them into the text in the next few days.
...
Furthermore, I helped tighten the text and make minor modifications to the figures.
...
I coauthored figures 5 and 6 and made edits throughout the text.

I am happy to add as much information as necessary to this section when resubmitting 
the thesis. If any point remains unclear please let me know.
